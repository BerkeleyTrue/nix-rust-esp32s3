...
Unfortunately, I could not get nix to build an esp project. There where just to many artifacts to get set up correctly. 
...
idf components are listed in the cargo toml under package.metadata.esp-idf-sys.extra_components
