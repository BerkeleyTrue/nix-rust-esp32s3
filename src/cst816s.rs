// source https://github.com/tstellanova/cst816s/blob/main/src/lib.rs
...
use esp_idf_svc::hal::{gpio::GpioError, i2c::I2cError};
...
where
    ...
    PINT: InputPin,
    RST: StatefulOutputPin<Error = GpioError>,
{
    ...
    pub fn read_registers(&mut self) -> Result<(), Error> {
    ...
    pub fn read_truncated_registers(&mut self) -> Result<(), Error> {
        let read_reg = [Self::REG_FIRST; 1];
        self.i2c
            .write_read(
