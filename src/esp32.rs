...
use esp_idf_svc::hal::spi::config::{Config, DriverConfig, Mode, Polarity, Phase};
use esp_idf_svc::hal::gpio::{PinDriver, AnyIOPin, OutputPin, AnyOutputPin, Output};
...
impl slint::platform::Platform for EspPlatform<'_> {
